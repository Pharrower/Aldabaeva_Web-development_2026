...
Данные подгружаются сервером через Thymeleaf-фрагменты, что обеспечивает SEO-оптимизацию и высокую скорость первичной отрисовки страницы.
...
![Главная страница приюта](images/screenshots2.png)
...
### Визуализация
![Каталог питомцев](images/screenshots3.png)
...
### Визуализация
![Страница О нас](images/screenshots6.png)
...
### Визуализация
![Профиль пользователя](images/screenshots11.png)
...
### Визуализация
![Страница Помощь](images/screenshots4.png)
